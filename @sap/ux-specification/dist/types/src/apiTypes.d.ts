...
/**
 * Instances of this type might be added (as array) to property 'messages' of a schema property in order to indicate that there are issues with this property.
 *
 * @property type - The type of message, indicating its severity (error, warning, info).
 * @property text - The message text providing details about the issue.
 */
...
export type CustomExtensionData = FPMControllerExtension | FPMCustomAction | FPMActionMenu | FPMCustomHeaderSection | FPMCustomFilter | FPMCustomPage | FPMCustomSection | FPMCustomSubSection | FPMCustomTableColumn | FPMCustomView | FPMListReport | FPMObjectPage | FPMCustomField;
/**
 * API Version
 */
...
export interface ReadAppParams {
    /**
     * Path to application of instance of application access.
     */
    app: string | ApplicationAccess;
    /**
     * Instance of mem-fs.
     */
    fs?: Editor;
    /**
     * Instance of external extension logger.
     */
    logger?: ExtensionLogger;
    /**
     * Parse application and pages JSON schemas to tree structure model.
     *
     * @default false
     */
    skipParsing?: boolean;
...
export interface ReadAppResult {
    /**
     * Virtual files generated for the application.
     */
    files: File[];
    /**
    ...
    version: ApiVersion;
    /**
     * Instance of application access.
     */
...
export interface Specification {
    ...
    readApp: (options?: ReadAppParams) => Promise<ReadAppResult>;
}
