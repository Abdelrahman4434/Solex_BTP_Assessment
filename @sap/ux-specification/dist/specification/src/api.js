...
const fpmWriterMap = new Map([
    ...
    [ux_specification_types_1.CustomExtensionType.ActionMenu, fe_fpm_writer_1.generateActionMenu],
...
function generateSchema(generateParameters) {
    ...
    if (generateParameters[ux_specification_types_1.FioriElementsVersion.v2]) {
        ...
        if (v2Params[ux_specification_types_1.SchemaType.ListReport]) {
            const { genericSchema, entitySet, annotations, manifest, fragments, flex, logger } = v2Params[ux_specification_types_1.SchemaType.ListReport];
            schema = (0, generate_1.generateListReportInterfaceV2)(genericSchema, entitySet, annotations, manifest, fragments, flex, logger);
        }
        else if (v2Params[ux_specification_types_1.SchemaType.ObjectPage]) {
            const { genericSchema, entitySet, annotations, manifest, fragments, flex, logger } = v2Params[ux_specification_types_1.SchemaType.ObjectPage];
            schema = (0, generate_1.generateObjectPageInterfaceV2)(genericSchema, entitySet, annotations, manifest, fragments, flex, logger);
        }
            ...
            const { genericSchema, entitySet, annotations, manifest, fragments, flex, logger } = v2Params[ux_specification_types_1.SchemaType.AnalyticalListPage];
            schema = (0, generate_1.generateAnalyticalListPageInterfaceV2)(genericSchema, entitySet, annotations, manifest, fragments, flex, logger);
        }
    }
