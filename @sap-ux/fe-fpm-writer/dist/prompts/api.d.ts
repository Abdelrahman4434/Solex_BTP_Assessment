...
import type { Prompts, ValidationResults, PromptListChoices, PromptContext, PromptContextOptions, CodeSnippet, PromptsType } from './types';
...
export declare class PromptsAPI {
     ...
     */
    constructor(fs: Editor, project: Project | undefined, appId?: string, options?: PromptContextOptions);
    /**
     ...
     */
    static init(projectPath: string, appId?: string, fs?: Editor, options?: PromptContextOptions): Promise<PromptsAPI>;
    /**
